  ...
  return (
    <div className="my-10 mx-15">
        <div className="flex flex-row justify-between">
            <h2 className="text-2xl font-semibold text-[#6C584C] uppercase">Higiene</h2>
        ...
        <div className="grid grid-flow-row grid-col-1 md:grid-cols-2 xl:grid-cols-4 gap-10 mt-5">
            <div className="shadow-lg">
                <Link href="#">
                    <Image src="/images/hygiene.jpg" width={400} height={400} alt='Sitting Golden Retriever dog with human hands brushing its teeth' />
                </Link>
                <div className="p-5">
                    <h3><Link href="#" className="uppercase">Cepillos de dientes</Link></h3>
