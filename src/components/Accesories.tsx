  ...
  return (
    <div className="my-10 mx-15">
        ...
        <div className="flex flex-row justify-between">
            <h2 className="text-2xl font-semibold text-[#6C584C] uppercase">Accesorios</h2>
        ...
        <div className="grid grid-flow-row grid-col-1 md:grid-cols-2 xl:grid-cols-4 gap-5 mt-5">
            
            <div className="shadow-lg">
                <Link href="#">
                    <Image src="/images/accessories2.webp" width={1000} height={1000} alt="German shepard dog sitting with a red harness and leash on"/>
                </Link>
                
                <div className="p-5">
                    <h3><Link href="#" className="uppercase">Collares</Link></h3>
